...
},{"tiny-emitter":7}],2:[function(require,module,exports){
'use strict'
...
console.log('chunks: ', this._chunks[0].byteLength);
    ...
    // reader.addEventListener("loadend", function(ab) {
    //     this._arrayBuffer = ab;
    //     this._metadata.checksum = SparkMD5.ArrayBuffer.hash(ab);
    //     cb(ab, this._metadata.checksum);
    // }.bind(this));
...
BDC.__unpack = function (chunk) {
    ...
    console.log('using Buffer: ', typeof Buffer);
...
},{"array-keys":1,"buffer":3,"spark-md5":6}]},{},[8])(8)
});